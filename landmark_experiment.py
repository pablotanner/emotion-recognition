...
if __name__ == '__main__':
    ...
    for split in ['train', 'val', 'test']:
        ...
        np.save(f'{args.data_output_dir}/{split}_landmarks_3d_unstandardized.npy', feature_splits_dict[split]['landmarks_3d_unstandardized'])
    ...
    def train_and_evaluate(X_train, y_train, X_val, y_val, class_weights):
    ...
    train_and_evaluate(np.load(f'{args.data_output_dir}/train_landmarks_3d.npy'), y_train,
                       np.load(f'{args.data_output_dir}/val_landmarks_3d.npy'), y_val, class_weights)
    ...
    train_and_evaluate(np.load(f'{args.data_output_dir}/train_landmarks_3d_unstandardized.npy'), y_train,
                       np.load(f'{args.data_output_dir}/val_landmarks_3d_unstandardized.npy'), y_val, class_weights)
